  ...
  >
    ...
    <div slot="description">
      <p>
        ...
        >tries to gather everything developers need to know about why their application crashed or
        is slow.
      </p>
      <p>
        ...
        >which are 15 SDKs supporting all popular frontend and backend frameworks based on
        JavaScript.
      </p>
    </div>
  </PortfolioItem>
  ...
  >
    ...
    <div slot="description">
      ...
      <p>
        ...
        >who builds and maintains the Android app. I joined the project to build a
        platform-independent progressive web app. It is based on Angular and relies on various
    ...
    <div slot="description">
      <p>
        JSR, short for<TextLink href="https://github.com/lms24/jsr" bold
          >Java Test Suite Reduction Framework</TextLink
        > is a tool for reducing the size of test suits in Java projects. This tool can be used to identify
        and eliminate redundant or obsolete test cases in a test suite.
      </p>
      <p>
  ...
  <PortfolioItem reverse title="CiteWorks" tags={[ANGULAR, FIREBASE, MATERIAL, ECHARTS, PYTHON]}>
    ...
    <div slot="description">
      <p>
        ...
        a university course about interactive data visualization of digital libraries. This app
        visualizes citation and co-authorship networks amongst academic publications.
      </p>
      <p>
